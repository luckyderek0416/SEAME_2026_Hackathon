...
class DecisionNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('drive_throttle', 0.19)   # 07-15 사용자: 흰 직선 0.20   # 1602us: DRIVE 기본(=직선 최고 속도).
                                                         # curve_slow/steer_slow 가 여기서 깎는다.
        self.declare_parameter('slow_throttle', 0.17)    # 07-15 사용자: 0.16→0.17
        ...
        self.declare_parameter('yellow_drive_throttle', 0.16)  # 07-15 사용자: 노란 구간 '상수' 속도
        ...
        self.declare_parameter('yaw_lap_threshold', 7.0)
        ...
        self.declare_parameter('gate_cluster_on_s', 0.20)  # run80 값 (레거시 스트림용 B 스침 배제)    # 군집 누적 ON 카운트 문턱 (run76 약피처 0.19 배제, 실선 0.5+ 통과)
