...
class DecisionNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('slow_throttle', 0.17)
        ...
        self.declare_parameter('yellow_drive_throttle', 0.16)
        ...
        self.declare_parameter('merge_blind_bias', 0.0)   # 병합 브리지 무검출 조향(+=좌). RA 탈출 직후 무차선 구간용
        ...
        self.declare_parameter('ra_ref_drive_s', 25.0)
        ...
        self.declare_parameter('ra_direct_fire', 1)   # 1=카운트 성립 즉시 발화 (STOPLINE 청정 스트림 전용 — stopline_mode 1 필수)
