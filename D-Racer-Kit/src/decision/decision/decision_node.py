...
class DecisionNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('drive_throttle', 0.25)   # 07-15 사용자 고정   # 1602us: DRIVE 기본(=직선 최고 속도).
                                                         # curve_slow/steer_slow 가 여기서 깎는다.
        self.declare_parameter('slow_throttle', 0.23)    # 07-15 사용자 고정
        ...
        self.declare_parameter('yellow_drive_throttle', 0.25)  # 07-15 사용자 고정
