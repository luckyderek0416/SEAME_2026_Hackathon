...
class LaneNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('crossline_sw_gate', 1)              # yellow crossline gate enters exit-fallback context
        self.declare_parameter('sw_entry_frames', 1200)            # hold the exit-fallback context after the gate
        ...
        self.detector = LaneDetector(
            ...
            crossline_sw_gate=int(gp('crossline_sw_gate').value),
            sw_entry_frames=int(gp('sw_entry_frames').value),
